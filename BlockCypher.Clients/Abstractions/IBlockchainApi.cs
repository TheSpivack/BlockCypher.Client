...
public interface IBlockchainApi
{
    ...
    /// </returns>
    public Task<Blockchain> Chain(BlockCypherRequest? request = null);
    ...
    /// </returns>
    public Task<Block> BlockHash(string blockHash, GetByBlockHashRequest? request = null);
    ...
    /// </returns>
    public Task<Block> BlockHeight(int blockHeight, GetByBlockHeightRequest? request = null);
    ...
    public Task<string> Feature(string name, BlockCypherRequest? request = null);
}